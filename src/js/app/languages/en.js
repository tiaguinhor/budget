	...
	$rootScope.$watch('language', function(value){
		if(value == 'en'){
			...
			$rootScope.translate = {
				...
				"service": "Services",
				"placeholderNewPageTitle": "Home, About, News, Contact...",
				"placeholderNewPageDescription": "The home page will have content about the company...",
				"placeholderNewPageType": "Static is unalterable or against payment pages. Dynamic is that the user can change page content such as banners, news, etc.",
